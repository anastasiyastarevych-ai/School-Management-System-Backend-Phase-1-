...
class IsAdminUserOrReadOnly(permissions.BasePermission):
    """Дозволяє читання для всіх, але запис тільки для ADMIN"""
    def has_permission(self, request, view):
...
class BranchViewSet(viewsets.ModelViewSet):
    """Керування філіями (Читання для всіх, редагування тільки ADMIN)"""
...
class SubjectViewSet(viewsets.ModelViewSet):
    """Керування предметами (Читання для всіх, редагування тільки ADMIN)"""
...
class StudentViewSet(viewsets.ModelViewSet):
    """Керування студентами (Читання для всіх, редагування тільки ADMIN)"""
...
class StudentGroupViewSet(viewsets.ModelViewSet):
    """Керування групами студентів (Читання для всіх, редагування тільки ADMIN)"""
...
class SubscriptionPlanViewSet(viewsets.ModelViewSet):
    """Керування тарифною сіткою підписок (Читання для всіх, редагування тільки ADMIN)"""
...
class StudentSubscriptionViewSet(viewsets.ModelViewSet):
    """Прив'язка підписок до студентів (Читання для всіх, редагування тільки ADMIN)"""
